...
class CreateDomainsTechnicalBkpTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('domains_technical_bkp', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('domains_technical_bkp');
    }
}
