...
class ReduceRegistrantEmailAndRegistrantZip extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        {
            if ($value->column_name=='registrant_email' 
                && $value->character_maximum_length>110) 
            { 
            ...
            if ($value->column_name=='registrant_zip' 
                && $value->character_maximum_length>15) 
            { 
                Schema::table('leads', function (Blueprint $table){
                    $table->string('registrant_zip',15)->change();
                });
                //break;
            }
        }
