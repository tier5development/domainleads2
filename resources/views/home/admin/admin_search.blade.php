                     ...
                     <dl class="dropdown">
                        ...
                        <dd>
                           <div class="mutliSelect">
                              <ul>
                                 <li>
                                    <input type="checkbox" name="domain_ext[0]" value="com" @if($domainExtarray['domain_ext'][0]=='com') checked @endif/>com
                                 </li>
                                 <li>
                                    <input type="checkbox" name="domain_ext[1]" value="io" @if($domainExtarray['domain_ext'][1]=='io') checked @endif />io
                                 </li>
                                 <li>
                                    <input type="checkbox" name="domain_ext[2]" value="net" @if($domainExtarray['domain_ext'][2]=='net') checked @endif />net
                                 </li>
                                 <li>
                                    <input type="checkbox" name="domain_ext[3]" value="org" @if($domainExtarray['domain_ext'][3]=='org') checked @endif />org
                                 </li>
                                 <li>
                                    <input type="checkbox" name="domain_ext[4]" value="gov" @if($domainExtarray['domain_ext'][4]=='gov') checked @endif/>gov
                                 </li>
                                 <li>
                                    <input type="checkbox" name="domain_ext[5]" value="edu" @if($domainExtarray['domain_ext'][5]=='edu') checked @endif />edu
                                 </li>
                                 <li>
                                    <input type="checkbox" name="domain_ext[6]" value="in" @if($domainExtarray['domain_ext'][6]=='in') checked @endif/>in
                                 </li>
                              </ul>
                           </div>
                        </dd>
