                        ...
                        <div class="container customCont cancelDomain">
                            <div class="col-sm-8 innerContentWrap">
                                <div class="col-sm-12 createForm">
                                    ...
                                    <p>You seem to have pending payments. Please clear your last pending payment to continue using domainleads.</p>
                                </div>
                                <button id="clear-pending-payments" class="orangeBtn orangeBtnCentered">Clear Last Payment</button>
                            </div>
                        </div>
                    </div>
                </div>
