...
<html lang="en">
  <head>
    ...
    <title>|| Sign Up Confirmation ||Domain Leads</title>
    <link rel="shortcut icon" type="text/css" href="images/favicon-dl.ico">
          ...
          <div class="col-xs-9 bottomRight">
            <nav class="menu clearfix">
              ...
              <ul>
                ...
                <a class="button gradiant-orange">login</a>
              </ul>
            </nav>
          </div>
        </div>
      ...
      <div class="container customCont cancelDomain signUpConfirmation">
        <div class="col-sm-8 innerContentWrap">
            <div class="col-sm-12 createForm">
              <img src="images/icon_success.png" alt="domain cancel">
              <h2>Congratulation <span>Jon!</span></h2>
              <p>You have succesfully signed up for your Domain Leads Account.<br>Please check your email to activate your account.</p>
          </div>
        </div>
      </div>
    </div>
